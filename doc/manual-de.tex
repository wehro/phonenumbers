...
\addbibresource{phonenumbers.bib}
...
\DeclareNewLayer[background,bottommargin,mode=picture,hoffset=7cm,
  contents={\includegraphics{receiver}}]{Telefonebene}

\AddLayersToPageStyle{scrheadings}{Telefonebene}
\AddLayersToPageStyle{plain.scrheadings}{Telefonebene}
...
\newcommand*\sieheAnhang[1]{(siehe Anhang~\ref{#1})}
...
\begin{itemize}
\item die Teilnehmerrufnummer mit einer 0 beginnt \cite[5]{BNA-nummernplan},
\item die Teilnehmerrufnummer einschließlich Durchwahlnummer weniger als 3 Stellen hat \cite[5]{BNA-nummernplan},
...
\begin{sidebyside}
  \phonenumber[country=FR]{0199006789}
\end{sidebyside}
Die zweite Ziffer ermöglicht die Zuordnung der Nummer zum Festnetz oder einer besonderen Verwendung (z.\,B. Mobilfunk). Bestimmte Nummerngruppen sind für Überseegebiete reserviert
\sieheAnhang{vorwahlen-FR}.
\begin{sidebyside}
...
Nummern für die maschinelle Kommunikation, die mit 07\,00 oder 09\,01 beginnen, haben mehr als zehn Ziffern. Sie sind im Mutterland 14-stellig, in den Überseegebieten 13-stellig \cite[17, 24]{ARCEP}.
\begin{sidebyside}
...
\vglAbschnitt{verlinkung}, da sie aus dem Ausland nicht erreichbar sind \cite[29]{ARCEP}.
...
\end{sidebyside}
Dagegen entfällt für Saint-Pierre und Miquelon die Regionalvorwahl 05\,08 bei Auslandsanrufen vollständig \cite[12]{ARCEP}.
\begin{sidebyside}
...
\WarnungWenn
\begin{itemize}
\item die Nummer nicht genau 10 oder 4 Stellen hat (außer bei Nummern, die mit 07\,00 oder 09\,01 beginnen),
...
\item eine Nummer, die mit 07\,00 oder 09\,01 beginnt, nicht 14 oder 13 Stellen hat.
\end{itemize}
...
\end{minipage}
\hfill
\adjustimage{valign=c}{british-phone-box}
...
\egroup
\Quellen \cite[20-22]{ARCEP}, \cite{wikipedia-FR-fr}, \cite{wikipedia-FR-de}
...
\egroup
\Quellen \cite[14, 17, 23\psq, 26\psq]{ARCEP}, \cite{wikipedia-FR-fr}, \cite{wikipedia-FR-de}
...
\end{multicols}
\Quellen \cite{Ofcom-plan}, \cite{Ofcom-numbering}
...
\item[2.7] \today
\begin{itemize}
\item Ergänzung der neuen deutschen Mobilfunkvorwahlen 01\,51\,87, 01\,51\,88, 01\,51\,89 und 01\,56\,36
\item Entfernung der deutschen Mobilfunkvorwahl 01\,57\,05
\item Ergänzung der neuen französischen Vorwahlen 01\,51\,0, 02\,68\,7--9, 02\,81\,0, 03\,41\,0, 04\,41\,0, 05\,08\,60, 05\,41\,0, 05\,91, 05\,97, 05\,98\,50--64, 05\,98\,7, 05\,98\,8, 05\,98\,9, 09\,01, 09\,01\,5--9, 09\,37, 09\,38, 09\,39, 09\,39\,5--9, 09\,41\,0, 09\,47\,00--09 und 09\,90\,0
\item Ergänzung der britischen Sondervorwahlen  07337--07339, 07343--07353 und 07370--07373
\item Entfernung der britischen Sondervorwahlen  07027, 07046, 07096 und 0820
\item Ergänzung der neuen nordamerikanischen Vorwahlen 257, 273, 353, 357, 369, 436, 457, 465, 471, 483, 529, 532, 538, 542, 565, 621, 624, 633, 679, 686, 729, 738, 748, 761, 821, 837, 879, 924 und 942
\end{itemize}
\end{description}
